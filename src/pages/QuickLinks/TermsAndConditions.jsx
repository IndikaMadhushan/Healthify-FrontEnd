        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sm:p-8 lg:p-10">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              ...
              "The Company", "Ourselves", "We" and "Us", refers to Healthify.
          ...
          <section className="mb-8">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              ...
              within the company on a need to know basis only use any
          ...
          <section className="mb-8">
            ...
            <p className="text-sm text-gray-600 leading-relaxed mb-4">
              ...
              are regarded as confidential and therefore will not be divulged to
              any third party, other than our healthcare providers and partners,
              ...
              reasonable notice of such a request. Clients are requested to
              retain copies of any literature issued in relation to the
              provision of our services. Where appropriate, we shall issue
              Client's with appropriate written information, handouts or copies
              of records as part of an agreed contract, for the benefit of both
              parties.
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              ...
              treatment decisions should be made by certified medical
              professionals. The platform should not be used as a substitute for
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm text-gray-600">
              ...
              <li>
                All data sharing is subject to applicable healthcare regulations
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 space-y-2 text-sm text-gray-600">
              <li>
                All system content, design, and analytics models are property of
                the Healthify development team
              </li>
              <li>
              ...
              <li>
                Your health data remains your property, but you grant us license
                to process it to provide our services
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              ...
              notification. Continued usage after such modifications constitutes
              acceptance of the updated policies. We encourage you to review
          ...
          <section>
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              ...
              contact our support team through the Contact Support button below
              or via the Contact Us section.
            </p>
          </section>
        </div>
      </div>
