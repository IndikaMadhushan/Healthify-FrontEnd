      ...
      <section className="relative bg-linear-to-br from-teal-600 via-teal-500 to-green-500 text-white py-16 sm:py-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative z-10">
          ...
          <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-2xl mx-auto">
            Have questions about Healthify? We'd love to hear from you. Send us
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    />
                    {errors.name && <p className="text-red-500 text-[10px] mt-1 uppercase">{errors.name}</p>}
                  </div>
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1.5 uppercase tracking-wider">
                      Email Address
                    ...
                    />
                    {errors.email && <p className="text-red-500 text-[10px] mt-1 uppercase">{errors.email}</p>}
                  </div>
                </div>
                ...
                <div>
                  ...
                  ></textarea>
                  {errors.message && <p className="text-red-500 text-[10px] mt-1 uppercase">{errors.message}</p>}
                </div>
