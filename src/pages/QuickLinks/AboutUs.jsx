        ...
        <section className="relative bg-linear-to-br from-secondary to-[#86C443] text-white py-16 sm:py-24 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center relative z-10">
            ...
            <p className="text-base sm:text-lg text-gray-100 leading-relaxed max-w-2xl mx-auto">
              <strong>Healthify </strong> is a centralized digital platform that
              integrates medical records, health tracking, and doctor
              collaboration into a single, secure system. It is designed to help
              individuals take full control of their health information in a
              simple and intelligent way, making healthcare more accessible,
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              {[
                ...
                },
                {
                  ...
                  desc: "Set medicine, appointment reminders and reminders for health related activities",
                },
                {
                  icon: Share2,
                  title: "Secure Sharing",
                  desc: "Share medical data only with the verified SLMC doctors",
                },
              ].map((item, i) => (
                <div
                  key={i}
