...
export default function AboutUs() {
  ...
  <div className="max-w-2xl mx-auto">
    <div className="space-y-4 text-gray-700 text-sm sm:text-base leading-relaxed">
      <p>
        <strong>Healthify </strong> is developed by Group 2, a team of passionate 3rd-year Computer Science students from the 13th batch, Department of Computer Science, University of Ruhuna, as their group project.
      </p>
    </div>
  </div>
</section>
