import { Calendar, Pill, CalendarCheck, Droplet, FolderOpen } from "lucide-react";
...
export default function Tabs({ activeTab, setActiveTab }) {
  ...
  return (
    <div className="bg-white rounded-full shadow-md p-2 flex justify-between mb-8 border border-black/20">
      {tabs.map((tab) => {
        const Icon = tab.icon;
