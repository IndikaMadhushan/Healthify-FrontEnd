  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-6">
        <h2 className="text-2xl text-black font-semibold mb-6">Period Tracker</h2>
        ...
        <div className="flex gap-4 mb-6">
          ...
          <div className="flex-1 border-2 border-pink-300 rounded-lg p-4 text-center flex items-center justify-center">
            ...
            <span className="text-pink-500 font-semibold">Today is the day</span>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="flex space-x-2 mb-4">
            {['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'].map(month => (
              <button key={month} className="px-3 py-2 border rounded hover:bg-gray-50 text-sm text-black bg-white border-teal-500">
                {month}
              </button>
            ))}
          </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <h3 className="text-lg text-black font-semibold mb-4">Period History</h3>
