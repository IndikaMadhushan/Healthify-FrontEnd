...
export default function Footer() {
  return (
    <div
      id="footer"
      className="w-full bg-white text-[#454545] pt-8 border-t-2 border-t-secondary "
    >
      {/* MAIN FOOTER CONTENT */}
      <div
        className="
      ...
      >
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          <img
            src="logo.png"
            className="w-[160px] md:w-[200px] mb-3"
            alt="Logo"
          />
        ...
        <div className="flex flex-col items-center justify-center">
          <div className="flex flex-col items-center mb-4 md:mb-6">
            <img
              src="Phone.png"
              className="w-[30px] md:w-[40px] mb-1"
              alt="Phone"
            />
        ...
        <div className="flex flex-col items-center md:items-end">
          ...
          <div className="flex flex-col gap-[6px] md:gap-[10px] text-[12px] md:text-[14px] font-light">
            <Link to="/home" className="hover:text-secondary/75">
              Home
            </Link>
            <Link to="/aboutUs" className="hover:text-secondary/75">
              About Us
            </Link>
            <Link to="/contactUs" className="hover:text-secondary/75">
              Contact Us
            </Link>
            <Link to="/faq" className="hover:text-secondary/75">
              FAQs
            </Link>
            <Link to="/privacyPolicy" className="hover:text-secondary/75">
              Privacy Policy
            </Link>
      ...
      <div className="w-full h-[45px] md:h-[50px] bg-secondary flex items-center justify-center text-white">
        <p className="text-[14px] md:text-[16px]">
          &copy; {new Date().getFullYear()} Healthify System. All rights
          reserved.
        </p>
      </div>
    </div>
