...
export function AdditionalNotesCard({ formData, onChange }) {
  ...
  const textAreaBase =
    "w-full min-h-[60px] px-3 py-2 rounded-md bg-gray-100 border border-gray-300 text-[15px] text-gray-700 focus:ring-2 focus:ring-secondary focus:border-secondary outline-none resize-y transition";
  const inputBase =
